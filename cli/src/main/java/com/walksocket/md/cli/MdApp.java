...
public class MdApp implements AutoCloseable {
  ...
  public static void main(String args[]) throws Exception {
    ...
    try (com.walksocket.md.cli.MdApp app = new com.walksocket.md.cli.MdApp()) {
      // set log
  ...
  private static void help() throws IOException {
    InputStream in = com.walksocket.md.cli.MdApp.class.getClassLoader().getResourceAsStream("help.txt");
