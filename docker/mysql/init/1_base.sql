...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `base` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `t_comment_mismatch` (
  ...
  `name` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'USER NAME',
...
INSERT INTO `t_diff_generated` (`id`, `name`) VALUES (1,'a'),(3,'c');
...
INSERT INTO `t_diff_generated_stored` (`id`, `name`) VALUES (1,'a'),(3,'c');
...
-- Dump completed on 2024-09-24 23:38:45
